...
\fbox{%
    \parbox {\textwidth}{%
        \small
        No support for deprecated, unsupported operating system (such as Microsoft\textregistered \space Windows Phone\textregistered) is being required as the market share of those system is well below 0.1\%
...
\begin{itemize}
    ...
    \end{itemize}
    \item Strong 2-factor authentication (or stronger) must be required for Staff operations, which imply non-negligible consequences on store operativeness and availability to end users.
    \item Keep 6+ months old logs about staff related operations and related authentication sessions.
